...
export const ImageDetails = () => {
  ...
  navigation.setOptions({ title: /*params.imageUrl*/'hi' });
  ...
  return (
      <>
        <SafeAreaView style={styles.viewContainer}>
          <TouchableOpacity onPress={() => handleImagePress(/*params.imageUrl*/'hi')}>
            <PhotoItem id={ 1 } imageUrl={ /*params.imageUrl*/'hi' } focussed={true}/>
          </TouchableOpacity>
